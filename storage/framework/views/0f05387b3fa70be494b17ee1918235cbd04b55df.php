...
<div class="col-md-4 w-100">
    <div class="form-group">
        <?php echo Form::label('user_type', __('business.usertype') . ':*'); ?>

        <div class="input-group">
            <span class="input-group-addon">
                <i class="fas fa-user"></i>
            </span>
            <?php echo Form::select('user_types',["Merchant"=>"Merchant", "Buyer"=>"Buyer"], '',
                ['class' => 'form-control select2_register', 'required']);; ?>
...
<div class="clearfix"></div>
</fieldset><?php /**PATH D:\workspace\laravel\Shoppersbill-Web-App\resources\views/business/partials/register_form.blade.php ENDPATH**/ ?>
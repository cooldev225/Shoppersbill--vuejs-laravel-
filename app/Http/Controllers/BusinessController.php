...
class BusinessController extends Controller
{
    ...
    */
    ...
    public function getRegister()
    {
        ...
        // $usertype = User::select("user_type")->groupBy('user_type')->pluck('user_type');
        $usertype=["merchant"=>"merchant","buyer"=>"buyer"];
    ...
    public function postRegister(Request $request)
    {
        ...
        try {
            $validator = $request->validate(
                ...
                'user_types.min' => __('validation.min', ['attribute' => __('business.usertype')]),
                'user_types.required' => __('validation.required', ['attribute' => __('business.usertype')]),
            ...
            //Create owner.
            $owner_details = $request->only(['user_types', 'surname', 'first_name', 'last_name', 'username', 'email', 'password', 'language']);
